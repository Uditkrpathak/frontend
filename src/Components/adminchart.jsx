...
const ReviewTable = () => {
    ...
    return (
        <div className="w-full p-4 mx-auto lg:w-4/5 md:p-8">
            <h2 className="mb-6 text-xl font-semibold text-center md:text-2xl lg:text-3xl">Teacher Review Analysis</h2>
            {averageRatings ? (
                <table className="w-full border border-collapse border-gray-300">
                    <thead className="text-white bg-purple-500">
                        <tr>
                            <th className="px-4 py-2 text-left border border-gray-300">Category</th>
                            <th className="px-4 py-2 text-left border border-gray-300">Average Rating</th>
                        </tr>
                    </thead>
                    <tbody>
